...
class CellTest {
  ...
  void getNewState2NeighborsAlive() throws URISyntaxException {
    ...
    try {
      ...
      assertEquals(2, grid.getMyCells().get(0).get(0).getMyNeighbors().getNumberOfLiveNeighbors()); // assert 2 neighbors
  ...
  void getNewState3NeighborsAlive() throws URISyntaxException {
    ...
    try {
      ...
      assertEquals(3, grid.getMyCells().get(2).get(1).getMyNeighbors().getNumberOfLiveNeighbors()); // assert 3 neighbors
  ...
  void getNewStateOverpopulation() throws URISyntaxException {
    ...
    try {
      ...
      assertTrue(grid.getMyCells().get(2).get(2).getMyNeighbors().getNumberOfLiveNeighbors() > 3); // assert overpopulation
  ...
  void getNewStateUnderpopulation() throws URISyntaxException {
    ...
    try {
      Grid grid = new Grid(path);
      assertEquals(1, grid.getMyCells().get(0).get(0).getMyValue()); // assert alive
      assertTrue(grid.getMyCells().get(0).get(0).getMyNeighbors().getNumberOfLiveNeighbors() < 2); // assert underpopulation
      int actualNewState = grid.getMyCells().get(0).get(0).getNewState();
